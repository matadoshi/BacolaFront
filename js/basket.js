...
basket.forEach(prod=>{
    ...
    let allsubtotal=total
    x+=`
        <div class="prod-select col-lg-12 row align-items-center">
...
function minus(event){
    ...
    if(value==1){
        ...
        let basket = JSON.parse(localStorage.getItem('basket'));
        let id=event.target.parentElement.nextElementSibling.nextElementSibling.getAttribute('data-remove');
